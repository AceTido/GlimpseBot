...
module.exports.run = async (bot, message, args) => {
    ...
    .setDescription("MultiBot Information")
    .setColor(botconfig["bot_setup"].main_embed_color)
    .setThumbnail("https://faxes.zone/imagebanks/7rhme.png")
    .addField("Bot Name", `${bot.user.username} / Original Name: MultiBot`)
    .addField("Servers", bot.guilds.size)
    .addField("Credits", `This bot is made by FAXES#8655`)
    .addField("Information", `This bot (MultiBot) was created by FAXES and is a packaged bot which you can obtain via the FAXES Gaming Discord. This bot comes with a license which is agreed to by the product purchaser. \nhttps://faxes.zone/discord`);

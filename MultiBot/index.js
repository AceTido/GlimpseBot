...
// Bot startup
console.log("Setting up MultiBot. this might take a few seconds!")
...
bot.on("ready", async () => {
    console.log('\x1b[32m%s\x1b[0m', `MultiBot is online and set up! I'm on ${bot.guilds.size} servers.`);
